...
export const lookupApi = {
    ...
    getTermFormLookups: async (_options?: { signal?: AbortSignal }): Promise<TermFormLookups> => {
...
export function __resetLookupCachesForTests(): void {
    itemFormLookupsCache = { data: null, promise: null };
    termFormLookupsCache = { data: null, promise: null };
    itemCategoriesCache = { data: null, promise: null };
    categoryBrandsByCategoryCache.clear();
    categoryBrandsByCategoryPromise.clear();
}
