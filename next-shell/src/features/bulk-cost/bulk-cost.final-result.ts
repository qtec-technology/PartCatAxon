...
export const BULK_COST_AY_CP_COLUMNS: FinalResultColumnDefinition[] = [
  ...
  { excelColumn: 'BU', key: 'wireTT', label: 'TT', kind: 'number', editable: true },
  { excelColumn: 'BV', key: 'customClear', label: 'CC', kind: 'number', editable: true },
  ...
  { excelColumn: 'CI', key: 'ttFinal', label: 'TT Final', kind: 'number', editable: true },
  { excelColumn: 'CJ', key: 'ccFinal', label: 'CC Final', kind: 'number', editable: true },
  { excelColumn: 'CK', key: 'qlc', label: 'QLC', kind: 'number', editable: true },
  { excelColumn: 'CL', key: 'spk', label: 'SPK', kind: 'number', editable: true },
  { excelColumn: 'CM', key: 'qocVal', label: 'QOC', kind: 'number', editable: true },
