        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto mt-2 md:mt-0">
            ...
            <Button
              ...
              disabled={waitState}
              size="sm"
              className="h-8 flex-1 md:flex-none bg-[#DAE9F5] hover:bg-[#C8DEF0] text-[#2264A0] border border-[#A0C0E0] shadow-sm px-3"
            >
              <span className="mr-1 text-xs font-bold">{waitState ? 'WAIT...' : 'SEARCH'}</span>
